        ...
        <div class="col s12 ">
            <div class="card">
                ...
                <div class="card-content">
                    <span class="card-title">Catálogo del Mantenimientos</span>
...
<div id="ventanaModal" class="modal">
    <div class="modal-content">
        <h4>Detalles Mantenimiento</h4>
        <br>
        <form id="formulario" method="post">
            <div class="row">
                <div class="input-field col s12">
                    <input type="hidden" name="id_Man" id="id_Man">
                    <input type="text" name="Man" id="Man" class="validate">
                    <label class="active" for="Man">Tipo de Mantenimiento: </label>
                </div>
            </div>
        </form>
    </div>
