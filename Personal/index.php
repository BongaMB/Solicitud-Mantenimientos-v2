        ...
        <div class="col s12 ">
            <div class="card">
                ...
                <a id="Dep" href="../Solicitud/index.php" class="btn-floating btn-large waves-effect waves-light right blue lighten-2">
                 ...
                 <a id="pdf" href = "../reportes/rptPersonal.php" class="btn-floating btn-large waves-effect waves-light right blue lighten-2" target="_blank">
                    <i class="material-icons">picture_as_pdf</i>
                </a>
                <div class="card-content">
                    <span class="card-title">Catálogo de Personal</span>
...
<div id="ventanaModal" class="modal">
    <div class="modal-content">
        <h4>Detalles Personal</h4>
        <br>
        <form id="formulario" method="post">
            <div class="row">
                <div class="input-field col s12">
                    <input type="hidden" name="idPer" id="idPer">
                    <input type="text" name="nombrePer" id="nombrePer" class="validate">
                    <label class="active" for="nombrePer">Nombre del Empleado:</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12">
            ...
            <div class="row">
                <div class="input-field col s9">
                    <input type="text" name="cargo" id="cargo" class="validate">
                    <label for="correo" class="active">Cargo del Empleado</label>
                </div>
