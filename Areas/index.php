...
<div id="ventanaModal" class="modal">
    <div class="modal-content">
        <h4>Detalles de Areas</h4>
        <br>
        <form id="formulario" method="post">
            <div class="row">
                <div class="input-field col s12">
                    <input type="hidden" name="id_area" id="id_area">
                    <input type="text" name="nomArea" id="nomArea" class="validate">
            ...
            <div class="row">
               ...
               <div class="row">
                <div class="input-field col s12">
                    <input type="text" name="oficina" id="oficina" class="validate">
                    <label class="active" for="oficina">Oficina:</label>
                </div>
            </div>
        </form>
    </div>
