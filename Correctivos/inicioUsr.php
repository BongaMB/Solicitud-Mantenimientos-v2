...
<head>
    <meta charset="UTF-8">
    <title>Panel Cliente - Mantenimiento</title>
    ...
    <style>
        ...
        .option-card {
            ...
            width: 100%;
            max-width: 350px; /* Tamaño adaptado para verse bien solo */
            margin: 0 auto;
        }
...
<body>
    ...
    <ul id="slide-out" class="sidenav sidenav-fixed">
        <li>
            <div class="user-view">
                ...
                <span class="white-text name" style="font-size: 1.4rem;">Panel Cliente</span>
                ...
                <div class="col s12">
                    <a href="index.php" class="black-text">
                        <div class="option-card center-align">
                            ...
                            <div class="option-title">Solicitud de Mantenimiento Correctivo</div>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Lógica del botón Hamburguesa para abrir/cerrar
